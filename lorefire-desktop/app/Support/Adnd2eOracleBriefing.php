...
class Adnd2eOracleBriefing
{
    ...
    public static function markdown(): string
    {
        ...
        $lines = [
            ...
            '',
            '### Answer labels',
            '- '.RuleKernel::ORACLE_LABEL.': RuleKernel / Adnd2e numbers and procedures.',
            '- '.RuleCards::ORACLE_LABEL.': user-entered spell, monster, kit, or racial cards.',
            '- '.TableLaw::ORACLE_LABEL.': this table\'s house rulings, not 1989 PHB core.',
            '- LOOKUP: live-core book name and TSR number. Pages unknown unless a citation row exists. Name 1989 PHB/DMG, kit books, race books, and Forgotten Realms MC first. Do not use 1995 pagination. Do not cite 1E.',
            '- '.IngestLock::ORACLE_LABEL_FGG.': fan-generated or OGL material, only if this table opted in.',
            '- Prefer KERNEL, CARD, TABLE LAW, and campaign notes. Never invent official spell or monster text.',
            '',
            '### Combat',
