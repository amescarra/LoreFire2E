...
echo "      bash $DESKTOP/scripts/linux-5090-launch.sh"
echo "      bash $DESKTOP/scripts/linux-5090-launch.sh --install-desktop"
echo "      # or:"
echo "      cd $DESKTOP"
...
echo "    Anker PowerConf S500 (BT 84:D3:52:EE:10:E3) — PipeWire/BlueZ, no Anker driver:"
echo "      bash $DESKTOP/scripts/linux-5090-audio.sh --apply"
echo "    See LINUX-5090.md § Anker PowerConf S500. arecord -l will not list the BT mic."
echo ""
